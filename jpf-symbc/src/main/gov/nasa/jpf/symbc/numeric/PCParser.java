...
public class PCParser {
  ...
  static public Map<SymbolicReal, Object>	symRealVar = new HashMap<SymbolicReal,Object>(); // a map
  // between symbolic real
  // variables and DP variables
  static Map<SymbolicInteger,Object>	symIntegerVar = new HashMap<SymbolicInteger,Object>(); // a map
  // between symbolic
  // variables and DP variables
  ...
  public static boolean addConstraint(Constraint cRef, ProblemGeneral pbToSolve) {
    //this is insane
    pb=pbToSolve;
    return addConstraint(cRef);
  }
