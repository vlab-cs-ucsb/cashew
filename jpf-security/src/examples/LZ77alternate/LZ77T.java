...
public class LZ77T
{
    ...
    public static byte[] compress(final byte[] in) throws IOException {
        ...
        while ((nextChar = mIn.read()) != -1) {
            ...
            if (tempIndex != -1) {
                ...
                final String codedString = new StringBuilder().append("~").append(matchIndex).append(new String("~")).append(currentMatch.length()).append(new String("~")).append((char)nextChar).toString();
    ...
    public static String compress (final String in) {
    ...
    public static void main(String[] args) {
    	...
    	// String compress
    	String input = "Cookie: abcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdefadfadfadfafdadfadfdfadfadfadfa";
...
//    		mOut.print(input);
//    		mOut.flush();
//			byte[] compressed_byte = compress(oStream.toByteArray());
//			mOut.close();
//			
//			final ByteArrayInputStream stream = new ByteArrayInputStream(compressed_byte);
//	        final InputStreamReader reader = new InputStreamReader((InputStream)stream);
//	        final Reader mIn = (Reader)new BufferedReader((Reader)reader);
//	        StringBuilder compressed_byte_readable = new StringBuilder();
//	        int nextChar;
//	        while ((nextChar = mIn.read()) != -1) {
//	        	compressed_byte_readable.append((char)nextChar);
//	        }
//	        mIn.close();
//	        System.out.println("\nUsing Byte Array Version");
//	        System.out.println(compressed_byte_readable.toString());
//			
//		} catch (IOException e) {
//			e.printStackTrace();
//		}
