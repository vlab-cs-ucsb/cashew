 ...
 * This is a standard parent-first loader to avoid multiple class instances when
 * using our Run*.jar tools
 *
 * The main reason for having our own classloader is dynamically configured
...
public class JPFClassLoader extends URLClassLoader {
  ...
  // snyako: Test. Do not commit back to main JPF code!!!!!!
   ...
   *
   * Note this is ignored according to the javadocs if the provided url is
   * already in the classpath. We do rely on this feature since me might add
   * jpf.jar several times during bootstrap
   */
  @Override
