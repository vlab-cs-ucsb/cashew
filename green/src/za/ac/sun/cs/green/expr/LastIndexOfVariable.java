...
public class LastIndexOfVariable extends IntVariable {
	...
	public LastIndexOfVariable(String name, Integer lowerBound, Integer upperBound, Expression source, Expression expression) {
	...
	public LastIndexOfVariable(String name, Object original, Integer lowerBound, Integer upperBound, Expression source, Expression expression) {
	...
	public boolean equals(Object object) {
		if (object instanceof LastIndexOfVariable) {
			LastIndexOfVariable variable = (LastIndexOfVariable) object;
...
//	}
	...
	public List<String> getOperationVector(){
		List<String> res = new ArrayList<String>(Arrays.asList("LastIndexOfVar"));
		return res;
	}
