...
public class LastIndexOfChar2Variable extends IntVariable {
	...
	public LastIndexOfChar2Variable(String name, Integer lowerBound, Integer upperBound, Expression source, Expression expression, Expression mindist) {
	...
	public LastIndexOfChar2Variable(String name, Object original, Integer lowerBound, Integer upperBound, Expression source, Expression expression, Expression mindist) {
	...
	public boolean equals(Object object) {
		if (object instanceof LastIndexOfChar2Variable) {
			LastIndexOfChar2Variable variable = (LastIndexOfChar2Variable) object;
...
//	}
	...
	public String toString(){
		String result = source.toString() + ".lastIndexOf(" +expression.toString() +"," + mindist.toString() + ")";
		return result;
	}
	
	@Override 
	public List<String> getOperationVector(){
		List<String> res = new ArrayList<String>(Arrays.asList("LastIndexOfChar2Var"));
		return res;
	}
