...
public class IndexOfChar2Variable extends IntVariable {
	...
	public IndexOfChar2Variable(String name, Integer lowerBound, Integer upperBound, Expression source, Expression expression, Expression mindist) {
	...
	public IndexOfChar2Variable(String name, Object original, Integer lowerBound, Integer upperBound, Expression source, Expression expression, Expression mindist) {
	...
	public boolean equals(Object object) {
		if (object instanceof IndexOfChar2Variable) {
			IndexOfChar2Variable variable = (IndexOfChar2Variable) object;
...
//	}
	...
	public List<String> getOperationVector(){
		List<String> res = new ArrayList<String>(Arrays.asList("IndexOfChar2Var"));
		return res;
	}
