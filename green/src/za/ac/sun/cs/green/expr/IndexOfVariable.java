...
public class IndexOfVariable extends IntVariable {
	...
	public IndexOfVariable(String name, Integer lowerBound, Integer upperBound, Expression source, Expression expression) {
	...
	public IndexOfVariable(String name, Object original, Integer lowerBound, Integer upperBound, Expression source, Expression expression) {
	...
	public boolean equals(Object object) {
		if (object instanceof IndexOfVariable) {
			IndexOfVariable variable = (IndexOfVariable) object;
...
//	}
	...
	public List<String> getOperationVector(){
		List<String> res = new ArrayList<String>(Arrays.asList("IndexOfVar"));
		return res;
	}
