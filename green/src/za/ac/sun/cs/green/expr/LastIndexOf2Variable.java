...
public class LastIndexOf2Variable extends IntVariable {
	...
	public LastIndexOf2Variable(String name, Integer lowerBound, Integer upperBound, Expression source, Expression expression, Expression mindist) {
	...
	public LastIndexOf2Variable(String name, Object original, Integer lowerBound, Integer upperBound, Expression source, Expression expression, Expression mindist) {
	...
	public boolean equals(Object object) {
		if (object instanceof LastIndexOf2Variable) {
			LastIndexOf2Variable variable = (LastIndexOf2Variable) object;
...
//	}
	...
	public List<String> getOperationVector(){
		List<String> res = new ArrayList<String>(Arrays.asList("LastIndexOf2Var"));
		return res;
	}
