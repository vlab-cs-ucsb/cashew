...
public class SATZ3Service extends SATSMTLIBService {
	...
	private final String DEFAULT_Z3_PATH = "/home/tegan/TOOlS/z3/bin/external/z3";
	...
	protected Boolean solve0(String smtQuery) {
		String output = "";
		System.out.println("smtQuery is " +smtQuery);
		try {
			Process process = Runtime.getRuntime().exec(z3Command);
			System.out.println("z3commad is " +z3Command);
