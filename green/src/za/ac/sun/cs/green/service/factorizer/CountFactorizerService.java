...
public class CountFactorizerService extends BasicService {
	...
	public Set<Instance> processRequest(Instance instance) {
		...
		if (result == null) {
			...
			instance.setData(COUNT, BigInteger.ONE);
	...
	public Object childDone(Instance instance, Service subservice, Instance subinstance, Object result) {
		...
		if (unsolved.contains(subinstance)) {
			BigInteger total = (BigInteger)instance.getData(COUNT);
	...
	public void report(Reporter reporter) {
		...
		reporter.report(getPrefix(), "totalConstraints = " + constraintCount);
		reporter.report(getPrefix(), "factoredConstraints = " + factorCount);
	}
