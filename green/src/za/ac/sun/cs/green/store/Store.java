...
public interface Store {
	...
	/**
	 * Returns the BigInteger integer that is associated with the given key. If there is
	 * nothing associated with the key, the method returns <code>null</code>.
	 * 
	 * @param key
	 *            the key to use for the lookup
	...
	/**
	 * Returns the byte array that is associated with the given key. If there is
	 * nothing associated with the key, the method returns <code>null</code>.
	 * 
	 * @param key
	 *            the key to use for the lookup
	 * @return the byte array that is stored with the key or <code>null</code> if
	 *         no association is found
	 */
